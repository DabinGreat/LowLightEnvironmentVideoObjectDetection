...
model = dict(
    ...
    noise_cfg=dict(noise_type='no_add')
)

# dataset settings
dataset_type = 'DarkFarmVIDDataset'
# data_root = '/data/darkfarm_recover/lstm_base/'
data_root = '/dataSSD/darkfarm_recover/lstm_base/'
# data_root = '/data1/chengdabing/darkfarm_recover/lstm_base/'
img_norm_cfg = dict(
...
data = dict(
    ...
    train=dict(
            type=dataset_type,
            ann_file=data_root + 'Annotations/darkfarm_vid_e2e_train.json',
    ...
    val=dict(
        type=dataset_type,
        ann_file=data_root + 'Annotations/darkfarm_vid_e2e_val.json',
        img_prefix=data_root,
        ref_img_sampler=dict(
            # _delete_=True,
            num_ref_imgs=8,
