...
# model setting
model = dict(
    type='SelsaFastDVDnetDetect',
    pretrains=dict(
        detector='./checkpoints/detector/base_resblock_selsa_tra_vid_e7_fix.pth',
        cleaner='./checkpoints/cleaner/FastDVDNet_darkfarm_pre_cleaner.pth',
    ),
    detector=dict(
        type='FasterRCNN',
...
train_pipeline = [
    ...
    # dict(type='SeqResize', img_scale=(128, 128), keep_ratio=True),
...
test_pipeline = [
    ...
    dict(type='SeqResize', img_scale=(1000, 600), keep_ratio=True),
    # dict(type='SeqResize', img_scale=(600, 400), keep_ratio=True),
    dict(type='SeqBrighten', m=0.25),
