...
model = dict(
    ...
    cleaner=dict(type='ResCleaner',
                 ...
                 norm_eval=True,
                 style='pytorch'),
    aggregator=dict(type='Denoising2Aggergator',
                    in_channel=[1024, 2048],
                    mid_channel=[256, 512],
                    out_channel=[2048, 512],
                    layer_name=['layer3', 'layer4'],
...
# resume_from = './work_dirs/llvod_selsa_tra_r50_l34/epoch_1.pth'