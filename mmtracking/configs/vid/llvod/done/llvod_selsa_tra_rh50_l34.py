...
train_pipeline = [
    ...
    # dict(type='SeqResize', img_scale=(320, 320), keep_ratio=True),
...
# runtime settings
total_epochs = 10
evaluation = dict(metric=['bbox'], interval=11)
# resume_from = './work_dirs/llvod_selsa_tra_rc50_l34/epoch_1.pth'