...
model = dict(
    ...
    detector=dict(
        ...
        backbone=dict(
            ...
            norm_eval=True,
            insert_tag=[True, True, True, True],
            insert_cfg=dict(type='DenoisingAggregator',
                            num_blocks=1,
                            num_layers=8,
                            emb_nums=3,
                            with_rdb=True,
    ...
    noise_cfg=dict(noise_type='a7s3', noise_level=dict(
        mode=None, am=0.8, k_ratio=30, read_ratio=250))  # psnr ~10dB
)

# dataset settings
dataset_type = 'ImagenetVIDDataset'
# data_root = '/data1/chengdabing/VID_DET/ILSVRC2015/'
data_root = '/dataSSD/chengdabing/VID_DET/ILSVRC2015/'
# data_root = '/data/vid_det_test/ILSVRC2015/'
# data_root = '/data/VID_DET/ILSVRC2015/'
img_norm_cfg = dict(
...
data = dict(
    ...
    # val=dict(
    #     type=dataset_type,
    #     ann_file=data_root + 'annotations/imagenet_vid_8_val.json',
    #     img_prefix=data_root + 'Data/VID',
    #     ref_img_sampler=dict(
    #         # _delete_=True,
    #         num_ref_imgs=4,
    ...
    # test=dict(
    #     type=dataset_type,
    #     ann_file=data_root + 'annotations/imagenet_vid_16_val.json',
    #     img_prefix=data_root + 'Data/VID',
    #     ref_img_sampler=dict(
    #         # _delete_=True,
    #         num_ref_imgs=4,
...
resume_from = './work_dirs/llvod_insert_plugins_l34_i1234_no_taf_vid_a7s3/epoch_1.pth'