...
class SelsaNewDetect(BaseVideoDetector):
    ...
    def __init__(self,
        ...
        super(SelsaNewDetect, self).__init__()
    ...
    def forward_train(self,
        ...
        if self.with_cleaner:
            ...
            for i in range(len(x_noise)):
                ...
                mse_losses[f'loss_mse_u_{i}'] = F.mse_loss(x_noise[i], x_clean[i])
                mse_losses[f'loss_mse_d_{i}'] = F.mse_loss(_x_noise[i], x_clean[i])
