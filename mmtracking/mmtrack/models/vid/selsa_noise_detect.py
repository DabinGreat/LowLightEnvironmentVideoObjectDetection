...
from mmtrack.core.utils import add_noise_clean_pairs


@MODELS.register_module()
class SelsaNoiseDetect(BaseVideoDetector):
    ...
    def __init__(self,
        ...
        super(SelsaNoiseDetect, self).__init__()
    ...
    def forward_train(self,
        ...
        _, all_x = self.detector.extract_feat(noise)
        x = []
        ref_x = []
