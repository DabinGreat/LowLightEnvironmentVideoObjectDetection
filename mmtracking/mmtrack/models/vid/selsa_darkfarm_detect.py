...
class SelsaDarkfarmDetect(BaseVideoDetector):
    ...
    def __init__(self,
        ...
        super(SelsaDarkfarmDetect, self).__init__()
    ...
    def forward_train(self,
        ...
        if self.with_cleaner:
            ...
            for i in range(len(x_noise)):
                ...
                feats_losses[f'loss_{self.loss_type}_{i}'] = feat_loss(x_noise[i], x_clean[i])
    ...
    def extract_feats(self, img, img_metas, ref_img, ref_img_metas):
        ...
        #     _, xs = self.detector.extract_feat(imgs)
        #     x, ref_x = [], []
        ...
        if frame_stride < 1:
            ...
            _, x = self.detector.extract_feat(img)
