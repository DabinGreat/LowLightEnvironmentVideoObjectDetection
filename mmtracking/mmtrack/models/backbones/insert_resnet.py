...
from mmtrack.models.builder import build_aggregator
            ...
            for _ in range(1, num_blocks):
                layers.append(
                    block(
                        ...
                        **kwargs))
            if insert_tag:
                insert_cfg['in_channels'] = inplanes
                insert_cfg['mid_channels'] = planes
                insert_cfg['channel_growth'] = 64
                layers.append(build_aggregator(insert_cfg))
...
class InsertResNet(nn.Module):
    ...
    def __init__(self,
                 ...
                 insert_tag=[False, False, False, False],
                 insert_cfg=None,
                 plugins=None,
                 with_cp=False,
    ...
    def train(self, mode=True):
        ...
        freezed."""
        super(InsertResNet, self).train(mode)
        self._freeze_stages()
