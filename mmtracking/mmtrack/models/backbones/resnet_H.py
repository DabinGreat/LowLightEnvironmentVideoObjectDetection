...
from mmtrack.models.aggregators import DenoisingAggregator
            ...
            for _ in range(1, num_blocks):
                layers.append(
                    block(
                        ...
                        **kwargs))
            if insert_plugins:
                layers.append(build_aggregator(plugins_cfg['type'], **plugins_cfg['cfg']))

                # layers.append(DenoisingAggregator(in_channels=inplanes,
                #                                   mid_channels=planes,
                #                                   channel_growth=planes))
