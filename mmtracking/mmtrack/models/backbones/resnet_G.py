...
class Bottleneck(nn.Module):
    ...
    def __init__(self,
        ...
        if not self.with_dcn or fallback_on_stride:
            self.conv2_tl = build_conv_layer(
                conv_cfg,
                planes,
                planes,
                kernel_size=3,
                ...
                dilation=dilation,
                bias=False)
            self.conv2_tr = build_conv_layer(
                conv_cfg,
                planes,
                planes,
                kernel_size=3,
                ...
                dilation=dilation,
                bias=False)
            self.conv2_bl = build_conv_layer(
                conv_cfg,
                planes,
                planes,
                kernel_size=3,
                ...
                dilation=dilation,
                bias=False)
            self.conv2_br = build_conv_layer(
                conv_cfg,
                planes,
                planes,
                kernel_size=3,
            ...
            self.conv2 = build_conv_layer(
                ...
                dilation=dilation,
                bias=False)
        self.pixel_shuffle = nn.PixelShuffle(self.split_size)
        self.add_module(self.norm2_name, norm2)
