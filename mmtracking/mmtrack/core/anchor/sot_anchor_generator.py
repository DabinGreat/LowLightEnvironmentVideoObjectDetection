...
class SiameseRPNAnchorGenerator(AnchorGenerator):
    ...
    def gen_single_level_base_anchors(self,
                                      ...
                                      ratios,
                                      center=None):
        """Generate dark_base anchors of a single level feature map.
        ...
        Args:
            ...
            center (tuple[float], optional): The center of the dark_base anchor
    ...
    def single_level_grid_anchors(self,
        ...
        Args:
            base_anchors (torch.Tensor): The dark_base anchors of a feature grid.
